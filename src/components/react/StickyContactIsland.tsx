...
const T = "all 0.5s cubic-bezier(0.4,0,0,1)";
...
export default function StickyContactIsland() {
  ...
  return (
    ...
    >
      {/* Fixed-size pill — never changes width or height */}
      <div
      ...
      >
        {/* Layer 1: "Speak to me" — visible when closed */}
        <div
          style={{
            position: "absolute",
            inset: 0,
        ...
        {/* Layer 2: Expanded buttons — visible when open */}
        <div
          style={{
            position: "absolute",
            inset: 0,
        ...
        {/* Icons on the right — visible when closed */}
        <div
          style={{
            position: "absolute",
            right: 6,
