  ...
  return (
    ...
    >
      <div
        ...
        style={{
          padding: hovered ? "8px 8px" : "14px 16px 14px 20px",
          gap: hovered ? "6px" : "14px",
        }}
      >
        ...
        <div
          ...
          style={{
            ...
            opacity: hovered ? 0 : 1,
            paddingRight: hovered ? "0px" : "0px",
          }}
        >
          <p className="text-[0.95rem] font-semibold text-black whitespace-nowrap leading-tight">
            Speak to me
          </p>
          <p className="text-[0.78rem] text-black/45 whitespace-nowrap leading-tight mt-0.5">
            Email or book a call
          </p>
        </div>

        {/* WhatsApp button — expands on hover to show label */}
        <a
        ...
        {/* Book a call button — expands on hover to show label */}
        <a
